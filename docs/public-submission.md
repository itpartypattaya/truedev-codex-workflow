...
Upload `dist/truedev-workflow-1.1.12.zip` as **Skills only** after running a fresh installed-plugin
...
- merge the release commit into `main`, publish the legal URLs, and tag `v1.1.12`;
